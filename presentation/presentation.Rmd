...
<br>
--
<font size="7">There is a small trend between HDI and suicide rates.<li>.</font>
</ul>
]
---
---
...
```{r linear-model, echo=FALSE, warning= FALSE, out.width="100%"}
...
<font size="7">For every increase of 0.1 in the HDI the linear model predicts an increase of 2.26 in the average number of suicide per 100000 people. <li>.</font>
</ul>
...
```{r reiduals-plot, echo=FALSE, warning= FALSE, out.width="100%"}
...
<font size="7"> The residuals plot gives a fairly random scatter. <li>.</font>
</ul>
...
<font size="7"> The adjusted r squared is 3.2% which is fairly small meaning the trend is not particularly strong. <li>.</font>
</ul>
...
<br>
--
<font size="13"><li>There is a small positive relationship between HDI and average number of suicides per 100000 people. This is the opposite to our previous hypothesis that there is a negative relationship. <br><br></font>

--
<font size="13"><li> A possible reason for this is that countries with a low HDI are not as effective in recording suicide deaths.<br><br></font>
