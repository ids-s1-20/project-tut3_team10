...
--
<font size=4"><li>Another hypothesis is that these trends are linked to HDI. Data from knoema:
...
--
<font size="4"><li>We will use a linear model to investigate this relationship. <br><br></font>
</ul>
