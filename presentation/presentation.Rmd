...
.pull-left[
<font size="10">Although this is pre recorded, comment in the chat why you think there is a massive drop in suicides.</font>
]
--
.pull-right[
...
.footnote[
<font size="8">Not all countries collected data for the early and late years, especially 2015.<br><br></font>
]
...
<br><br>
--
<font size="4">This clearly supports the statistic that male suicide is more frequent than female.<li>.</font>
</ul>
]
...
#More on the age variable
--

<font size="13">Type here<br><br></font>
--

```{r east-european-year, echo=FALSE}
suicides_clean %>% 
...
<br>
--
<font size="13"><li>Type here<br><br></font>
